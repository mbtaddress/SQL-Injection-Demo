...
if ( isset( $_GET['first_name'], $_GET['last_name'], $_GET['email'], $_GET['phone'], $_GET['password']) ) {

  $insert_query = 'INSERT INTO user(firstname, lastname, email, phone, password) VALUES (' .
                  "'{$_GET['first_name']}', '{$_GET['last_name']}', '{$_GET['email']}', '{$_GET['phone']}', '{$_GET['password']}')";
